...
{
    /// <summary>
    /// Queen can move and kill another pieces in both straight lines and diagonally
    /// </summary>
    public class Queen : Piece
    {
        private readonly int[] _candidateVectorX = { 1, 0, -1, 0, 1, -1, 1, -1 };
        private readonly int[] _candidateVectorY = { 0, 1, 0, -1, 1, -1, -1, 1 };

        public Queen(string id, GameColor color) : base(id, color)
        {
